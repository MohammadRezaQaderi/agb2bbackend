...
def get_info(user_id):
    try:
        ...
        service_exception_error_logging("ag_api/ocon", "get_info", str(e), {},
                                        {"user_id": user_id})
...
def get_dashboard(request_data, user_info):
    ...
    try:
        ...
        service_exception_error_logging("ag_api/ocon", "get_dashboard", str(e), request_data,
                                        user_info)
...
def get_report(request_data, user_info):
    try:
        ...
        service_exception_error_logging("ag_api/ocon", "get_report", str(e), request_data, user_info)
...
def get_management_report(request_data, user_info):
    try:
        ...
        service_exception_error_logging("ag_api/ocon", "get_management_report", str(e),
...
def change_student(request_data, user_info):
    try:
        ...
        service_exception_error_logging("ag_api/ocon", "change_student", str(e), request_data, user_info)
...
def change_comment(request_data, user_info):
    try:
        ...
        service_exception_error_logging("ag_api/ocon", "change_comment", str(e), request_data, user_info)
...
def change_user_info(request_data, user_info):
    try:
        ...
        service_exception_error_logging("ag_api/ocon", "change_user_info", str(e), request_data,
                                        user_info)
...
def get_students(request_data, user_info):
    try:
        ...
        service_exception_error_logging("ag_api/ocon", "get_students", str(e), request_data, user_info)
...
def change_user_voice(request_data, user_info):
    try:
        ...
        service_exception_error_logging("ag_api/ocon", "change_user_voice", str(e), request_data,
                                        user_info)
        return None, None, "اطلاعات شما با موفقیت تغییر نیافت."
...
def change_setting(request_data, user_info):
    try:
        ...
        service_exception_error_logging("ag_api/ocon", "change_setting", str(e), request_data, user_info)
...
def verify_user(user_id):
    try:
        ...
        service_exception_error_logging("ag_api/ocon", "verify_user", str(e), None,
                                        {"user_id": user_id})
        return None, None, "اطلاعات کاربر یافت نشد."
